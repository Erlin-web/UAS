    ...
    <div class="sidebar pe-4 pb-3">
      <nav class="navbar bg-light navbar-light">
        ...
        <div class="navbar-nav w-100">
          ...
          <a href="{{ route('peserta.beasiswa.index') }}" class="nav-item nav-link">
            <i class="fa fa-graduation-cap me-2"></i> Beasiswa
          </a>
          <a href="{{ route('peserta.pendaftaran.index') }}" class="nav-item nav-link">
            <i class="fa fa-clipboard-list me-2"></i>Pendaftaran
          </a>
          <a href="{{ route('peserta.persetujuan.index') }}" class="nav-item nav-link">
