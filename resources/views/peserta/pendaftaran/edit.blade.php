    ...
    <script>
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            try {
                ...
                // Load dropdown
                await Promise.all([
                    fetchSelect('/api/user?role=peserta', 'id_user', 'username', 'id_user', pendaftaran
                        .id_user),
                    fetchSelect('/api/beasiswa', 'id_beasiswa', 'nama_beasiswa', 'id_beasiswa',
                        pendaftaran.id_beasiswa),
                    fetchSelect('/api/list_universitas', 'kode', 'nama_universitas', 'kode', pendaftaran
                        .kode),
                ]);
            ...
            document.getElementById('formEditPendaftaran').addEventListener('submit', async e => {
                ...
                try {
                    ...
                    Swal.fire('Berhasil', response.message, 'success').then(() => {
                        window.location.href = "{{ route('peserta.pendaftaran.index') }}";
                    });
                } catch (err) {
                    console.error(err);
