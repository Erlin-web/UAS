                    ...
                    data.forEach((item, index) => {
                        ...
                        <td class="text-center">
                            ...
                            <button class="btn btn-sm btn-outline-warning" title="Edit"
                                onclick="window.location.href='/peserta/pendaftaran/${item.id_pendaftaran}/edit'">
                    ...
                    if (pendaftaran.dokumen && pendaftaran.dokumen.length > 0) {
                        ...
                        pendaftaran.dokumen.forEach(dok => {
                            ...
                            `;
                                ...
                                dokumenHtml += `
                                <div>
                                    <a href="${path}" target="_blank" class="btn btn-sm btn-primary mb-2">Lihat Dokumen (${ext.toUpperCase()})</a>
                                </div>
                            `;
                            }
                        });
